...
| AUDIT-2026-002 | Technique + vérification de l'ancrage SYSTEME_MAD | `backend/`, `frontend/`, CI GitHub Actions, `docs/integration-systeme-mad/`, registres T | Revue technique interne | 2026-08-05 | [docs/audits/2026-08-05-audit-technique-ancrage-systeme-mad.md](../audits/2026-08-05-audit-technique-ancrage-systeme-mad.md) | 2 ouverts — RSK-2026-001 (régression CSRF/session, CI rouge sur `main`) et RSK-2026-002 (tests de sécurité non exécutés), tous deux consignés en T2 | rapporté | Corriger RSK-2026-001 et RSK-2026-002 avant toute mise en production, puis rouvrir un audit de clôture | Run CI `maddevopss/CityFlow` #30916518659 (échec), reproduction locale documentée dans le rapport |
