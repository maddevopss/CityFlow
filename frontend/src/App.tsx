...
const MunicipalCitizenRequestsPage = lazy(() => import("./pages/MunicipalCitizenRequestsPage"));
const MunicipalCitizenRequestDetailPage = lazy(() => import("./pages/MunicipalCitizenRequestDetailPage"));
const CitizenServiceLevelsPage = lazy(() => import("./pages/CitizenServiceLevelsPage"));
const CitizenEscalationHistoryPage = lazy(() => import("./pages/CitizenEscalationHistoryPage"));
...
const routeFallback = <div role="status" aria-live="polite">Chargement de la page…</div>;
      ...
      <BrowserRouter future={routerFuture}>
        <Suspense fallback={routeFallback}>
          <Routes>
            ...
            <Route element={<ProtectedRoute requiredRole="CITIZEN"><Layout /></ProtectedRoute>}>
