...
const navigation = [
  { name: 'Tableau de bord', href: '/', icon: '📊', roles: ['ADMIN', 'MUNICIPAL_AGENT', 'INSPECTOR', 'VIEWER', 'PUBLIC_WORKS_MANAGER', 'FIELD_WORKER'] },
  ...
  { name: 'Travaux publics', href: '/work-orders', icon: '🚧', roles: ['ADMIN', 'MUNICIPAL_AGENT', 'PUBLIC_WORKS_MANAGER', 'FIELD_WORKER'] },
