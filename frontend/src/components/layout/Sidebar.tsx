...
const navigation = [
  { name: 'Tableau de bord', href: '/', icon: '📊', roles: ['ADMIN', 'MUNICIPAL_AGENT', 'INSPECTOR', 'VIEWER', 'MUNICIPAL_MANAGER', 'EXECUTIVE_VIEWER'] },
  { name: 'Vue exécutive', href: '/executive', icon: '🧭', roles: ['ADMIN', 'MUNICIPAL_MANAGER', 'EXECUTIVE_VIEWER'] },
