...
const navigation = [
  { name: 'Tableau de bord', href: '/', icon: '📊', roles: ['ADMIN', 'MUNICIPAL_MANAGER', 'MUNICIPAL_AGENT', 'INSPECTOR', 'VIEWER', 'PERMIT_REVIEWER'] },
  ...
  { name: 'Permis', href: '/permits', icon: '📝', roles: ['ADMIN', 'MUNICIPAL_AGENT', 'PERMIT_REVIEWER'] },
