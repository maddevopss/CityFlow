...
import PermitFeesPanel from './PermitFeesPanel';
...
const PermitDocumentsPanel: React.FC<Props> = ({ permitId, role }) => {
  ...
  return <div className="space-y-6">
    <PermitFeesPanel permitId={permitId} role={role} />
    <section className="space-y-3" aria-labelledby="permit-documents-title">
